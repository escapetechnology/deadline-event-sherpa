...
# from sherpa import rest
from sherpa.rest import RESTClientObject, RESTResponse
from sherpa.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sherpa.models, klass)
